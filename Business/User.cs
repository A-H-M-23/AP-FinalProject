...
namespace Business
{
    public class User
    {
        ...
        [RegularExpression("^[a-zA-z0-9@_.]{3,12}$", ErrorMessage = "Username is`nt Valid")]
        ...
        [RegularExpression("^[A-Za-z0-9._]{1,256}@[A-Za-z0-9]{1,256}[.][A-Za-z]{2,4}[.]{0,1}[A-Za-z]{0,4}", ErrorMessage = "Email is`nt Valid")]
